    ...
    <div className="min-h-dvh bg-white">
      ...
      <section className="relative pt-24 pb-16 overflow-hidden" aria-label="Como Funciona">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-white/80 text-sm md:text-base max-w-xl mx-auto leading-relaxed mb-8 text-pretty">
      ...
      <section className="py-16 bg-white" aria-labelledby="etapas-title">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 id="etapas-title" className="text-2xl font-bold text-gray-900 text-balance">6 Etapas Simples</h2>
          </div>
                ...
                >
                  ...
                  <div className={`flex-1 ${step.side === "right" ? "md:text-right" : ""}`}>
                    <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <h3 className="font-bold text-gray-900 text-base mb-2 text-balance">{step.title}</h3>
                      <p className="text-sm text-gray-600 leading-relaxed text-pretty">{step.desc}</p>
                    </div>
                  </div>

                  {/* Ícone central */}
                  <div className="hidden md:flex size-12 rounded-full bg-emerald-600 border-4 border-white shadow-md items-center justify-center shrink-0 z-10">
                    <i className={`${step.icon} text-white text-xl`} aria-hidden="true"></i>
                  </div>
      ...
      <section className="py-16 bg-gray-50" aria-labelledby="beneficios-title">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            ...
            <h2 id="beneficios-title" className="text-2xl font-bold text-gray-900 text-balance">
            ...
            {benefits.map((b) => (
              <div key={b.title} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                <div className="size-10 bg-emerald-100 rounded-lg flex items-center justify-center mb-4">
                  <i className={`${b.icon} text-emerald-600 text-xl`} aria-hidden="true"></i>
                </div>
                <h3 className="font-semibold text-gray-900 mb-2 text-balance">{b.title}</h3>
                <p className="text-sm text-gray-600 leading-relaxed text-pretty">{b.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white" aria-labelledby="faq-title">
        <div className="max-w-3xl mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            ...
            <h2 id="faq-title" className="text-2xl font-bold text-gray-900 text-balance">Perguntas Frequentes</h2>
          </div>
      ...
      <section className="py-16 bg-emerald-900" aria-label="Chamada para ação">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-white mb-3 text-balance">Pronto para começar?</h2>
