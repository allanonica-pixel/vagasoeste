  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="como-contratar" className="py-16 bg-white" aria-labelledby="processo-title">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            ...
            <h2 id="processo-title" className="text-2xl font-bold text-gray-900">Como contratar pela VagasOeste</h2>
          </div>
      ...
      <section className="py-16 bg-gray-50" aria-labelledby="recursos-title">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            ...
            <h2 id="recursos-title" className="text-2xl font-bold text-gray-900">Recursos do Painel Empresarial</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f) => (
              <div key={f.title} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                <i className={`${f.icon} text-2xl text-emerald-600 mb-3 block`}></i>
      ...
      <section className="py-16 bg-white" aria-labelledby="planos-title">
        <div className="max-w-5xl mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            ...
            <h2 id="planos-title" className="text-2xl font-bold text-gray-900">Planos para Empresas</h2>
          </div>
                ...
                <ul className="space-y-2 mb-6">
                  {plan.features.map((f) => (
                    <li key={f} className="flex items-center gap-2 text-sm text-gray-700">
                      <i className="ri-check-line text-emerald-500 shrink-0"></i>
                      {f}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-16 bg-gray-50" aria-labelledby="depoimentos-title">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            <h2 id="depoimentos-title" className="text-2xl font-bold text-gray-900">O que dizem as empresas parceiras</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
      ...
      <section className="py-16 bg-white" aria-labelledby="faq-empresas-title">
        <div className="max-w-3xl mx-auto px-4 md:px-6">
          <div className="text-center mb-10">
            <h2 id="faq-empresas-title" className="text-2xl font-bold text-gray-900">Dúvidas Frequentes</h2>
          </div>
      ...
      <section className="py-16 bg-emerald-900" aria-label="Chamada para ação empresas">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Pronto para contratar?</h2>
