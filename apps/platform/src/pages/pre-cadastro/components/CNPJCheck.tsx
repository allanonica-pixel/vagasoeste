      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-8">
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-emerald-50 flex items-center justify-center mx-auto mb-4">
            <i className="ri-search-eye-line text-emerald-600 text-2xl"></i>
          </div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Verificar CNPJ</h2>
        ...
        {status === "not_found" && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-5 mb-5">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-xl bg-red-100 flex items-center justify-center shrink-0">
                <i className="ri-search-line text-red-600 text-lg"></i>
              </div>
              <div>
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 mb-5">
            ...
            {(company.logradouro || company.bairro) && (
              <div className="mt-3 bg-white rounded-lg p-3 border border-emerald-100">
                <div className="flex items-center gap-1.5 mb-1">
                  <div className="w-4 h-4 flex items-center justify-center">
                    <i className="ri-road-map-line text-emerald-500 text-xs"></i>
                  </div>
